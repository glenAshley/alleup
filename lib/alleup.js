...
Alleup.prototype = {
	...
	upload: function(req, res, fileObj, callback, _scope) {
		var fileObj, callback, _scope

		if (typeof arguments[2] != 'function'){
			fileObj = arguments[2]
			callback = arguments[3]
			_scope = arguments[4] || null
		}
		else {
			callback = arguments[2]
			_scope = arguments[3] || null
		}
    ...
    var _this = this;
		...
		if (! fileObj){
			...
			_this.makeVariants(fileObj, function(err, file){
				callback(err, file, res)
			})
		}
	},
